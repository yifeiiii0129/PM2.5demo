# PM₂.₅ Mortality Explorer — Web Demo Version 3

Version 3 is an independent Robinson-projection website snapshot based on the
processed data and methods from Version 2. The Version 2 directory remains
unchanged; future presentation-layer changes can be made here without affecting
the earlier website.
...
- `app_v3.js`: map interaction, selectors, legends, country/city panels
